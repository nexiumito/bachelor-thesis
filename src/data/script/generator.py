...
if __name__ == "__main__":
    ...
    output_dirs = {
        ...
        "type3":  os.path.join(data_root, "type3"),
        "random": os.path.join(data_root, "random"),
    }
    ...
    for n_vars, m_clauses in type1_configs:
        ...
        fname = os.path.join(output_dirs["type1"], f"type1_v{n_vars}_c{m_clauses}.cnf")
        ...
        fname_ord = os.path.join(output_dirs["type1"],
    ...
    for n_vars, t, s in type3_configs:
        ...
        fname = os.path.join(output_dirs["type3"],
        ...
        fname_ord = os.path.join(output_dirs["type3"],
    ...
    for num_clauses, num_vars, k in random_configs:
        fname = os.path.join(output_dirs["random"],
    ...
    #
    #  Ces instances servent de baseline difficile pour notre DP.
    # ------------------------------------------------------------------
